...
file_id = '1PYjw9lKCby0Kuj1d_VGFPYRIHFSBX7FM'  # Define the Google Drive file ID

# Function to download the file from Google Drive using requests
def download_file_from_google_drive():
    URL = f'https://drive.google.com/uc?id={file_id}'  # Use the file_id directly
